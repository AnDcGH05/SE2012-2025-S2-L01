...
public class Act3_Marks {
    public static void main(String[] args) {
        ...
        System.out.println("Initializing the marks for all students");
        for (int i = 0; i < n; i++) {
        ...
        while (keepRunning) {
            System.out.println("\n--- MENU ---");
            System.out.println("1. Add / Re-enter all marks for a student");
            System.out.println("2. Update a specific mark");
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    if (isValidStudent(avgStudId, n)) {
                        double sum = marks[avgStudId - 1][0] + marks[avgStudId - 1][1] + marks[avgStudId - 1][2];
                ...
                case 5:
                    ...
                    if (isValidStudent(totalStudId, n)) {
                        double sum = marks[totalStudId - 1][0] + marks[totalStudId - 1][1] + marks[totalStudId - 1][2];
